...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="px-16 py-24 overflow-hidden">

      <div className="flex items-center justify-between mb-10 gap-10">
        {/* Left Content */}
        <div className="max-w-2xl">
            <h2 className="text-5xl font-black text-[#003e7e]">
            Get in Touch
            </h2>
        ...
        <div className="relative flex-shrink-0">
            <img
            src={rockwellBuilding}
            alt="Rockwell Building"
            className="w-[820px] object-contain"
            />
        </div>
        </div>
        ...
        >
          ...
          {/* Project Collaboration card */}
            ...
            <div className="flex items-start gap-4">
                ...
                <h3 className="text-xl font-bold text-[#003e7e] mb-1">
                ...
                {/* Logos */}
                <div className="flex flex-col items-center justify-center gap-8 ml-2 flex-shrink-0">
                <img
                    src={rockwellLogo}
                    alt="Rockwell"
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <RockwellLink
              ...
              desc="Industrial security for a connected world."
            ...
            <RockwellLink
              ...
              label="Contact Rockwell Automation"
              desc="Reach out to their global team."
