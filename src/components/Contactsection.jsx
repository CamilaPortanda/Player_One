    ...
    <section id="contact" className="px-6 md:px-16 py-16 md:py-24 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10 gap-6">
        <div className="max-w-2xl">
          <h2 className="text-3xl md:text-4xl font-black text-[#003e7e]">Get in Touch</h2>
          <p className="text-base md:text-md text-gray-700 leading-relaxed font-medium mt-4">
            We'd love to hear from you! Whether you have a question,
            feedback, or want to learn more about the project.
          </p>
          <div className="w-14 h-1 bg-[#003e7e] mt-5 rounded-full" />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <div className="flex items-center justify-center flex-shrink-0">
                <img src={myIcon} alt="Icon" className="w-8 h-8 object-contain" />
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-start gap-4">
              <div className="flex items-center justify-center flex-shrink-0">
                <img src={PlayerOneLogo} alt="Icon" className="w-8 h-8 object-contain" />
              </div>
              <div className="flex-1">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center gap-3 mb-4">
              <div className="flex items-center justify-center flex-shrink-0">
                <img src={romboRockwell} alt="Icon" className="w-8 h-8 object-contain" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-[#003e7e]">Rockwell Automation</h3>
                <p className="text-sm text-gray-600">Learn more about Rockwell Automation and their industrial cybersecurity solutions.</p>
              </div>
            </div>
            <RockwellLink icon={<img src={urlIcon} alt="" className="w-5 h-5 object-contain ml-2" />} label="Official Website" desc="rockwellautomation.com" href="https://www.rockwellautomation.com/en-us.html" />
            <RockwellLink icon={<img src={cyberIcon} alt="" className="w-5 h-5 object-contain ml-2" />} label="Cybersecurity Solutions" desc="Industrial security for a connected world." href="https://www.rockwellautomation.com/en-us/capabilities/industrial-cybersecurity/products-services/network-security.html" />
            <RockwellLink icon={<img src={contactIcon} alt="" className="w-5 h-5 object-contain ml-2" />} label="Contact Rockwell Automation" desc="Reach out to their global team." href="https://www.rockwellautomation.com/en-us/company/about-us/contact-us.html" />
          </div>
        ...
        >
          ...
          <div>
            <h3 className="text-xl font-bold text-[#003e7e] mb-3 mt-4">Connect With Us</h3>
            <p className="text-md text-gray-600 mb-4">Follow our progress and explore more about the project.</p>
